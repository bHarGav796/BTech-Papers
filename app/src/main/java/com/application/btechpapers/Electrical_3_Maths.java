...
public class Electrical_3_Maths extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://drive.google.com/drive/folders/1sNPlBCMcn7w0KaXpEyk4DoQxoKa2vYIV?usp=sharing");

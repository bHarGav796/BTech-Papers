...
public class Mech_2_Graphics extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        webView.loadUrl("https://drive.google.com/drive/folders/1uwEONrDWZh4doviLUkFXYdr_uApvV6U0?usp=sharing");
